...
public class ResourceLoader 
{
	...
	{
		String[] splitArray = fileName.split("\\.");	// Find the extension by splitting the string
		String ext = splitArray[splitArray.length - 1];	// Get last index, which is the extension
		...
		{	
			...
			while( ( line = meshReader.readLine() ) != null )
			{
				...
				{
					indices.add(Integer.parseInt(tokens[1]) - 1);	// -1 because we start at 0, not 1
